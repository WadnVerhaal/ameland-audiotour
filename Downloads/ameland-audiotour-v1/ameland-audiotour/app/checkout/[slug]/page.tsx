...
const COPY = {
  nl: {
    ...
    features: ['Audio en route in één mobiele ervaring', 'Geen app of account nodig', '48 uur toegang'],
    checkout: 'Afrekenen',
    intro: 'Vul je e-mailadres in voor de bevestiging.',
    email: 'E-mailadres',
    ...
    after: 'Na betaling start je direct. De bevestiging ontvang je per e-mail.',
  ...
  en: {
    ...
    features: ['Audio and route in one mobile experience', 'No app or account required', '48-hour access'],
    checkout: 'Checkout',
    intro: 'Enter your email address for the confirmation.',
    email: 'Email address',
    ...
    after: 'Start immediately after payment. We also send a confirmation by email.',
  ...
  de: {
    ...
    features: ['Audio und Route in einer mobilen Erfahrung', 'Keine App und kein Konto erforderlich', '48 Stunden Zugang'],
    checkout: 'Bezahlen',
    intro: 'Gib deine E-Mail-Adresse für die Bestätigung ein.',
    ...
    after: 'Nach der Zahlung kannst du sofort starten. Die Bestätigung senden wir per E-Mail.',
